...
class Purchase_Order(models.Model):
    ...
    warehouse = models.ForeignKey(Warehouse,related_name="purchase", on_delete=models.SET_NULL, null=True,
                                  default=None)
...
class Plain_Carton_Line_Item(models.Model):
    purchase_order = models.ForeignKey(Purchase_Order,related_name="plain_carton_line_items", on_delete=models.CASCADE)
...
# {
#     "amazon.de(bridegfix)": {
#         "OrderNumber1 (Purchase_Order)": {
#             1 : {
#                 "carton_qty_for_matrix": 15,
#                 "skus_that_need_to_be_send": {
#                    (Green)1 : {
#                         "plain_carton_line_items": {
#                             (Germany) 123: {"id": 123, "qty_cartons_in_plan": 3},
#                             (france) 456: {"id": 456, "qty_cartons_in_plan": 6},
#                         }
#                     },
#               (Yellow)2 : {
#                         "plain_carton_line_items": {
